...
public class CameraBehavior : MonoBehaviour {
    ...
    void Update() {
        ...
        if (rotateAroundPoint_Active) {
            ...
            //targetPos.y = 0f;
            targetPos += RotationRef.Instance.GetTransform.TransformDirection(rotateAroundPoint_DecalToCenter);
        }
    ...
    public Quaternion GetRotation() {
        tmpRot.LookAt(lookAtPoint_Target.position, RotationRef.Instance.GetUpDirection());
